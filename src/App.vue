<template>
  <div id="app">
    <div class="header">
      ...
      <a class="download" href="../gjtool/dist/gjtool.js" target="_blank">gjtool.js v1.2.1 下载</a>
      <a class="download2" href="../gjtool/dist/gjtool.min.js" target="_blank">gjtool.min.js v1.2.1 下载</a>
    </div>
